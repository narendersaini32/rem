...
import './App.css';
import DiscoverPropertiesScreen from './DiscoverPropertiesScreen.js';
...
export default class App extends Component {
  constructor(props) {
    ...
    this.dataSlots['ds_loggedInAsUserName'] = "";
    this.dataSlots['ds_loginScreenState'] = "";
  ...
  render() {
    let makeElementForScreen = (screenId, baseProps, atTop, forward) => {
      let screenProps = {
        ...
        'ds_loggedInAsUserName': this.dataSlots['ds_loggedInAsUserName'],
        'ds_loginScreenState': this.dataSlots['ds_loginScreenState'],
      };
      switch (screenId) {
        default:
          return null;
